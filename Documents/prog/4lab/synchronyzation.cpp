...
int main() {
    srand(time(NULL));
    printf("Введите количество оленей (N): ");
    scanf("%d", &N);
    printf("Введите количество эльфов (M): ");
    scanf("%d", &M);
    printf("Введите минимальное количество эльфов, чтобы разбудить Санту (K): ");
    scanf("%d", &K);
    printf("Введите время обсуждения (T секунд): ");
    scanf("%d", &T);
